...
export const painAnalysisSchema = z.object({
  biggestBusinessProblem: z
    .string()
    .describe("Identify the client's biggest business problem"),
  whyProblemExists: z.string().describe('Why the problem exists'),
  rootCause: z.string().describe('Root cause'),
  whyPreviousAttemptsFailed: z
    .string()
    .describe('Why previous attempts may have failed'),
